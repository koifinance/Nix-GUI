...
export enum ApiEndpoints {
  ...
  GetBtc = 'https://api.coingecko.com/api/v3/simple/price?ids=nix-platform&vs_currencies=btc,usd&include_24hr_change=true',
  GetEur = 'https://api.coingecko.com/api/v3/simple/price?ids=nix-platform&vs_currencies=btc,eur&include_24hr_change=true',
